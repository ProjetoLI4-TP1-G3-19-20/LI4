...
public class VisitasDAO
{
    ...
    public void deleteVaga(string nome, DateTime inicio) {
        ...
        try {
            msc.Open();
            string query = "DELETE FROM pessoadeinteresse_has_vagas WHERE nome = @n AND hora_inicio = @d";
            MySqlCommand mc = new MySqlCommand(query, msc);
            mc.Parameters.AddWithValue("@n", nome);
    ...
    public void deleteAllVagas(string nome) {

        MySqlConnection msc = new MySqlConnection(Connection);
        try {
            msc.Open();
            string query = "DELETE FROM pessoadeinteresse_has_vagas " +
                           "WHERE nome = @n";
            MySqlCommand mc = new MySqlCommand(query, msc);
            mc.Parameters.AddWithValue("@n", nome);
            mc.ExecuteNonQuery();
